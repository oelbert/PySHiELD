...
def srt_fn(
    ...
    if pcpdrp != 0:
        ...
        wdf0, wcnd0 = wdfcnd_fn(sh2oa0, smcmax, bexp, dksat, dwsat, sicemax)
    ...
    wdf0, wcnd0 = wdfcnd_fn(sh2oa0, smcmax, bexp, dksat, dwsat, sicemax)
    wdf1, wcnd1 = wdfcnd_fn(sh2oa1, smcmax, bexp, dksat, dwsat, sicemax)
    wdf2, wcnd2 = wdfcnd_fn(sh2oa2, smcmax, bexp, dksat, dwsat, sicemax)
    wdf3, wcnd3 = wdfcnd_fn(sh2oa3, smcmax, bexp, dksat, dwsat, sicemax)
...
def smflx_fn(
    ...
    if (pcpdrp * dt) > (0.001 * 1000.0 * (-zsoil0) * smcmax):
        ...
        sh2oa0 = (sh2o0 + sh2ofg0) * 0.5
        sh2oa1 = (sh2o1 + sh2ofg1) * 0.5
        sh2oa2 = (sh2o2 + sh2ofg2) * 0.5
        sh2oa3 = (sh2o3 + sh2ofg3) * 0.5
